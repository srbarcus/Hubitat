 ...
 *
 *  Donations are appreciated and allow me to purchase new YoLink devices for development: https://paypal.me/BarcusSoftware 
 *
 *  Refer to readme file for installation instructions.
 *     http://github.com/srbarcus/.../README.md
 *
 	...
 	dynamicPage(name: "about", title: pageTitle("About"), uninstall: true) {
 		section("") {	
			...
			paragraph "Donations are appreciated and allow me to purchase new YoLink™ devices for development. Please donate via PayPal by clicking on this Paypal button:"
				href url:"https://www.paypal.me/BarcusSoftware", title:"Paypal donation..."
			paragraph boldTitle ("© 2022 Steven Barcus. All rights reserved.")	                           
            paragraph boldTitle ("")
            paragraph boldTitle ("")
            if (removeDevices != "False"){
              paragraph boldRedTitle ("WARNING: Removing the application will delete all Hubitat devices created by the app! (This option can be disabled in the additional settings before removal)")
            }    
		}
	}        
}
...
def otherSettings() {    
    ...
    // Remove devices any no longer selected        
...
private def getCustomImagePath() {return "https://raw.githubusercontent.com/srbarcus/yolink/main/icons/"}
    //https://raw.githubusercontent.com/srbarcus/yolink/main/user_app_sbarcus_YoLink_Hub_Service_282.groovy
...
//  [code:000000, time:1643333250775, msgid:1643333250775, method:Home.getDeviceList, desc:Success, 
//  data:[devices:[[deviceId:d88b4c03000018ba, deviceUDID:c0718b1093624b4aa96be02eaa88635e, name:Backyard Gate, token:E30D52CF3B078C1D199110AC1E807CD4, type:DoorSensor],
//  [deviceId:d88b4c0300001c6a, deviceUDID:dd1fac14a24d49a7889b188b95593529, name:Mailbox, token:4705DED25C064104EFDEDAC669F25D80, type:DoorSensor], 
//  [deviceId:d88b4c160300e5de, deviceUDID:98725a3ccfe24fd0a2dd13506993eafe, name:YoLink Hub, token:7ABA758D82F1D8A2C23EA269E2E7A4DE, type:Hub]]]]
...
def pollAPI(body, name=null, type=null){
    def rc=null	             //DEFAULT: Return Code = null  
    def retry=0
...
def scheduledDay(weekday) {
   ...
   log.debug "Scheduled Day: ${weekday}" 
   return weekday 
}
